...
Public Class AccessForm
    ...
    ''' <summary>
    ''' Copies data rows from top DataGridView where Process is True to
    ''' bottom DataGridView
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks>
    ''' </remarks>
    Private Sub cmdCopyFromTopToBottom_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdCopyFromTopToBottom.Click
        ...
        For Each row As DataRow In dtFromTop.Rows
            If dtBottom.Select("CompanyName ='" & row.Field(Of String)("CompanyName") & "'").Count = 0 Then
                ...
                CType(bsData.Item(bsData.Find("CompanyName", row.Field(Of String)("CompanyName"))), DataRowView).
        ...
        Next
    End Sub
    Private Sub cmdClose_Click_1(ByVal sender As System.Object, ByVal e As EventArgs) Handles cmdClose.Click
        Close()
    End Sub
End Class
